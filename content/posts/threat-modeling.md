...
За много хора съвсем реална възможност е злонамерен познат или бивш партньор да
се опита да се докопа до лична информация, която не биха искали да споделят или
пък да им навреди като получи нужния достъп да се представя за тях на различни
места онлайн.

В същото време опасността държавата, службите или друга произволна огранизация с
огромни тхенически и финансови възможности и високи международни цели да се
опитва лично да ни навреди не звучи като нещо, за което всеки да се притеснява
чак толкова.

Горните две твърдения интуитивно звучат верни. До тях всъщност можем да
достигнем и с относително формалния процес на **моделиране на заплахи**.
Най-общо казано той се изразява в търсенето на отговор на някои генерални
въпроси:

 * Какви заплахи съществуват за въпросната система?
 * Колко е вероятна всяка от тези заплахи?
 * Какви биха били негативните последици от всяка от тези заплахи?
 * Какво трябва да се направи за ефективно предпазване от всяка заплаха и колко
   би „струвало“ това?
 * **Къде е границата на допустим риск?** Или иначе казано: „**За кои неща
   трябва да ми пука?**“
