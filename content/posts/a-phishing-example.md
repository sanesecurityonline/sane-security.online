...
промени. Домейните, от които се сервира копието на epay са просто други сайтове,
които обаче използват уязвима [система за управление на
съдържание](https://bg.wikipedia.org/wiki/%D0%A1%D0%B8%D1%81%D1%82%D0%B5%D0%BC%D0%B0_%D0%B7%D0%B0_%D1%83%D0%BF%D1%80%D0%B0%D0%B2%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5_%D0%BD%D0%B0_%D1%81%D1%8A%D0%B4%D1%8A%D1%80%D0%B6%D0%B0%D0%BD%D0%B8%D0%B5%D1%82%D0%BE).
Различни уязвимости в този тип системи могат да позволят на нападателите да
получат контрол над въпросните сайтове и да ги конфигурират, така че да сервират
въпросното копие на epay при отваряне на определена страница във въпросния сайт.
Когато някой от администраторите на такъв сайт разбере за проблема и предприеме
съответните мерки (отнемане на неоторизирания достъп на нападателите и
обновяване на платформата за управление на съдържание), нападателите намират
друг уязвим сайт и обновяват конфигурацията на tumblr блога, така че да сочи към
него. Така без значение кой е всъщност уязвимия сайт, който се използва за
сервиране на копието, препратката от phishing мейла, винаги ще изпрати жертвите
до „правилното“ място.
